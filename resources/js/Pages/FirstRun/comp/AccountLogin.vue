...
<template>
    <div class="flex shrink flex-col border shadow-sm rounded-xl bg-gray-800 border-gray-700 shadow-slate-700/[.7]">
        <div class="p-4 md:p-5 flex flex-col gap-y-5">
            <h3 class="mt-2 text-lg font-bold text-gray-800 dark:text-white leading-3">
                Log in to nawt!
            </h3>
            <p class="text-gray-800 dark:text-gray-400 leading-none">
            ...
            <div class="flex flex-col gap-y-2">
                <div>
                    <div class="flex rounded-md shadow-sm">
                        <span
                            class="px-4 inline-flex items-center min-w-fit rounded-l-md border border-r-0 text-sm bg-gray-700 border-gray-700 text-gray-400">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="fill-white stroke-white w-4">
                                <g data-name="Layer 2">
                                    <g data-name="at">
                        ...
                        <input type="text" placeholder="Username"
                            class="py-2 px-3 pr-11 block w-full shadow-sm rounded-r-md text-sm focus:z-10 focus:border-yellow-500 focus:ring-yellow-500 bg-slate-900 border-gray-700 text-gray-400">
                    </div>
                </div>
            ...
            <a class="inline-flex items-center gap-2 text-sm font-medium text-yellow-500 hover:text-yellow-600" href="#">
        ...
        <div class="bg-gray-100 border-t rounded-b-xl py-3 px-4 md:py-4 md:px-5 dark:bg-gray-800 dark:border-gray-700">
            <a class="inline-flex items-center gap-2 text-sm font-medium text-yellow-500 hover:text-yellow-600 cursor-pointer"
                @click="$emit('change')">
                Don't have a nawt! account yet?
            </a>
        </div>
    </div>
</template>